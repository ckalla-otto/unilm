#!/bin/bash
python run_class_finetuning.py --model beit_base_patch16_224 --data_path "/mnt/c/Projects/dali_usecase-image-embedding-training/generated/cache/basic_color_samples" \
